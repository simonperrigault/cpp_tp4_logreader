...
Requete::Requete(const string & p_ip, const string & p_userLogName, const string & p_authenticatedUser, const string & p_date, int p_hour, int p_minute, int p_gmt, const string & p_requestType, const string & p_target, const string & p_protocole, int p_status, int p_size, const string & p_referer, const string & p_navigator)
{
    #ifdef MAP 
    ...
    ip = p_ip;
    userLogName = p_userLogName;
    authenticatedUser = p_authenticatedUser;
    date = p_date;
    hour = p_hour;
    minute = p_minute;
    gmt = p_gmt;
